  ...
  function buildDraggable(Sortable) {
    ...
    var draggableComponent = {
      ...
      mounted: function mounted() {
        ...
        console.log('optionsAdded', optionsAdded);
      ...
      methods: {
        ...
        onDragStart: function onDragStart(evt) {
          draggingElement = evt.item.closest('li');
          console.log('onDragStart', evt, evt.item, draggingElement);
          this.context = this.getUnderlyingVm(draggingElement);
          draggingElement._underlying_vm_ = this.clone(this.realList[draggingElement.id]);
          // draggingElement._underlying_vm_ = this.clone(this.context.element || this.realList[draggingElement.id]);
          // 找到最近的父节点li
